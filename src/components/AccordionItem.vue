...
const headerVariants = cva(
  'flex items-center justify-between w-full text-left transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--ui-primary)] focus:ring-offset-2',
  {
    variants: {
      size: {
        sm: 'p-3 text-sm',
